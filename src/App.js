    ...
    <HashRouter>
      <div>
        ...
        <Routes>
          ...
          <Route path='/health' element={<NewsBox mode={mode} toggleMode={toggleMode} setProgress={setProgress} apiKey={apiKey} key='health' pageSize={pageSize} country="in" category="health" />}></Route>
          <Route path='/science' element={<NewsBox mode={mode} toggleMode={toggleMode} setProgress={setProgress} apiKey={apiKey} key='science' pageSize={pageSize} country="in" category="science" />}></Route>
          <Route path='/sports' element={<NewsBox mode={mode} toggleMode={toggleMode} setProgress={setProgress} apiKey={apiKey} key='sports' pageSize={pageSize} country="in" category="sports" />}></Route>
